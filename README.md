...
[![Stars](https://img.shields.io/github/stars/Axon-Exec-Update-v2.4?style=flat-square)](https://github.com)
...
git clone https://github.com/Axon-Exec-Update-v2.4.git
cd Axon-Exec-Update-v2.4
...
Axon v2.4 runs fully offline, uses under 40 MB of RAM at idle, and ships with more bundled scripts than most paid alternatives — all completely free.
...
<p align="center">
  <b>Axon v2.4</b> — Precision execution, zero compromise. The free Roblox executor built for 2026.
</p>
